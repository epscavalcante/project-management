...
<div class="page-header">
    ...
    <div class="d-flex align-items-center">
        <ul class="avatars">
            ...
            <li>
                <a href="#" data-toggle="tooltip" data-placement="top" title="{{ $member->name }}">
...
<form class="modal fade" id="user-manage-modal" tabindex="-1" role="dialog" aria-labelledby="user-manage-modal" aria-hidden="true" action="{{ route('projects.members.sync', $project->code) }}" method="POST">
    @csrf
